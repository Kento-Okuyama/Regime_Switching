...
load_and_preprocess <- function() {
  ...
  # Load the main data
  df <- readRDS('C:/Users/Methodenzentrum/Desktop/Kento/Empirical/202409021300/output/df__emp_42_N_80_T_51_O1_9_O2_3_L1_4_m_1.RDS')
...
for (init in 1:18) {
  ...
  filtered <- read_filtered_data(init, seed, 'C:/Users/Methodenzentrum/Desktop/Kento/Empirical/202409021300/')
