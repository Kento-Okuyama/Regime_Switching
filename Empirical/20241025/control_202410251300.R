...
control <- function(init, m, seed) {
  ...
  process <- function(m, seed) {
    ...
    saveRDS(df, paste0('C:/Users/Methodenzentrum/Desktop/Kento/Empirical/20241025/output/df__emp_', 
    ...
    saveRDS(filter, paste0('C:/Users/Methodenzentrum/Desktop/Kento/Empirical/20241025/output/filter__emp_', 
