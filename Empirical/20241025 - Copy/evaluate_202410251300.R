...
load_and_preprocess <- function() {
  ...
  # Load the main data
  df <- readRDS('C:/Users/Methodenzentrum/Desktop/Kento/Empirical/20241025 - Copy/output/df__emp_42_N_80_T_51_O1_9_O2_3_L1_4_m_1.RDS')
...
for (init in 16:16) {
  ...
  filtered <- read_filtered_data(init, seed, 'C:/Users/Methodenzentrum/Desktop/Kento/Empirical/20241025 - Copy/')
