setwd('C:/Users/kento/OneDrive - UT Cloud/Tuebingen/Research/Methods Center/Regime_Switching/Simulation/202309061900')
...
source('library_202309061900.R')
source('DGP_202309061900.R')
source('filtering_202309061900.R')
source('smoothing_202309061900.R')
