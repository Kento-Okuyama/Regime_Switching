...
N_vec <- c(25) #c(25, 25, 50, 50, 100, 100)
Nt_vec <- c(25) #c(25, 50, 25, 50, 25, 50)
O1 <- 6
O2 <- 3
L1 <- 2
...
# (df <- readRDS('C:/Users/kento/OneDrive - UT Cloud/Tuebingen/Research/Methods Center/Regime_Switching/Simulation/202309241300/output/df__sim_16_N_25_T_25_O1_6_O2_3_L1_2.RDS'))
# (filter <- readRDS('C:/Users/kento/OneDrive - UT Cloud/Tuebingen/Research/Methods Center/Regime_Switching/Simulation/202309241300/output/filter__sim_13_N_25_T_25_O1_6_O2_3_L1_2.RDS'))
