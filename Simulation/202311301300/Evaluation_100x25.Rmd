...
```{r log_sumLik_100x25_group, echo=TRUE}
...
```{r log_delta_100x25_group, echo=TRUE}
...
```{r cor_log_sumLik_log_delta_100x25_group, echo=TRUE}
...
```{r accuracy_100x25_group, echo=TRUE}
accuracy_100x25_group <- unlist(lapply(filter_list2, function(filter) (filter$output_best$TP + filter$output_best$TN) / N))
hist(accuracy_100x25_group)
summary(accuracy_100x25_group)
```

Then for **sensitivity**
```{r sensitivity_100x25_group, echo=TRUE}
...
```{r sensitivity_100x25_group_0, echo=TRUE}
sum(sensitivity_100x25_group<0.8)/length(seeds2)
```

And for **specificity**

```{r specificity_100x25_group, echo=TRUE}
...
```{r cor_sensitivity_specificity_100x25_group, echo=TRUE}
...
```{r theta_100x25_group, echo=TRUE}
...
```{r pred_drouput_rate_100x25_group, echo=TRUE}
par(mfrow = c(1, 2))
...
```{r cor_pred_drouput_rate_100x25_group, echo=TRUE}
