...
# table(S_25x25[,26])[2] / sum(table(S_25x25[,26])) 
# table(S_25x50[,51])[2] / sum(table(S_25x50[,51]))
# table(S_50x25[,26])[2] / sum(table(S_50x25[,26]))
# table(S_50x50[,51])[2] / sum(table(S_50x50[,51]))
# table(S_100x25[,26])[2] / sum(table(S_100x25[,26]))
# table(S_100x50[,51])[2] / sum(table(S_100x50[,51]))
