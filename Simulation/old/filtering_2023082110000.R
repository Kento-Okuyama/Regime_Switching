...
# plot the intra-individual latent score prediction
...
df_eta1_1 <- melt(as.array(eta1[obs,,1])); colnames(df_eta1_1) <- c('ID', 'time', 'eta1_1')
df_eta1_2 <- melt(eta1[obs,,2]); colnames(df_eta1_2) <- c('ID', 'time', 'eta1_2')
...
df_eta1_diff_1 <- melt(as.array(eta1_pred[obs,,1])); colnames(df_eta1_diff_1) <- c('ID', 'time', 'eta1_diff_1')
df_eta1_diff_1$eta1_diff_1 <- df_eta1_diff_1$eta1_diff_1 - df_eta1_1$eta1_1
df_eta1_diff_2 <- melt(as.array(eta1_pred[obs,,2])); colnames(df_eta1_diff_2) <- c('ID', 'time', 'eta1_diff_2')
df_eta1_diff_2$eta1_diff_2 <- df_eta1_diff_2$eta1_diff_2 - df_eta1_2$eta1_2
plot_eta1_diff_1 <- ggplot(data=df_eta1_diff_1, aes(time, eta1_diff_1, group=ID, color=as.factor(ID))) + geom_line(size=.5) + theme(legend.position='none')
plot_eta1_diff_2 <- ggplot(data=df_eta1_diff_2, aes(time, eta1_diff_2, group=ID, color=as.factor(ID))) + geom_line(size=.5) + theme(legend.position='none')
...
plot_grid(plot_eta1_pred_1_band, plot_eta1_1, plot_eta1_diff_1_band, plot_eta1_pred_2_band, plot_eta1_2, plot_eta1_diff_2_band, labels = "AUTO")
