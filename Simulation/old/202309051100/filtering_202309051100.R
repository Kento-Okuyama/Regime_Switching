    ...
    while (count <=3 && iter <= maxIter) {
      ...
      if (init == 1 && iter == 1) {
        ...
        if (iter %% 5 == 0) {
          ...
          plot_Lmdd_1 <- ggplot(data=df_Lmdd_1, aes(iteration, Lmdd_1, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[1,1]), color='black', linetype='dashed') + theme(legend.position='none')
          plot_Lmdd_2 <- ggplot(data=df_Lmdd_2, aes(iteration, Lmdd_2, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[2,1]), color='black', linetype='dashed') + theme(legend.position='none')
          plot_Lmdd_3 <- ggplot(data=df_Lmdd_3, aes(iteration, Lmdd_3, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[3,1]), color='black', linetype='dashed') + theme(legend.position='none')
          plot_Lmdd_4 <- ggplot(data=df_Lmdd_4, aes(iteration, Lmdd_4, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[4,2]), color='black', linetype='dashed') + theme(legend.position='none')
          plot_Lmdd_5 <- ggplot(data=df_Lmdd_5, aes(iteration, Lmdd_5, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[5,2]), color='black', linetype='dashed') + theme(legend.position='none')
          plot_Lmdd_6 <- ggplot(data=df_Lmdd_6, aes(iteration, Lmdd_6, group=initialization, color=initialization)) + geom_line() + geom_line(aes(y=df$Lmdd_true[6,2]), color='black', linetype='dashed') + theme(legend.position='none')
