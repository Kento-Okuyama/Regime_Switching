...
names(check_list) <- paste0('check_100x25_', seeds)
...
```{r sensitivity2_100x25_group, echo=FALSE}
sensitivity2_100x25_group <- unlist(lapply(check_list, function(check) check$sensitivity))
hist(sensitivity2_100x25_group)
summary(sensitivity2_100x25_group)
```

And for **specificity**
 
```{r specificity2_100x25_group, echo=FALSE}
specificity2_100x25_group <- unlist(lapply(check_list, function(check) check$specificity))
hist(specificity2_100x25_group)
summary(specificity2_100x25_group)
```

We can also check the correlation between **sensitivity** and **specificity**.

```{r cor_sensitivity2_specificity2_100x25_group, echo=FALSE}
plot(sensitivity2_100x25_group, specificity2_100x25_group)
cor(sensitivity2_100x25_group, specificity2_100x25_group)
```