...
par(mfrow=c(2,2))
plot(2:Nt, jP[1,2:Nt,1,1])
plot(2:Nt, jP[1,2:Nt,1,2])
plot(2:Nt, jP[1,2:Nt,2,1])
plot(2:Nt, jP[1,2:Nt,2,2])

par(mfrow=c(2,2))
plot(2:Nt, jV[1,2:Nt,1,1])
plot(2:Nt, jV[1,2:Nt,1,2])
plot(2:Nt, jV[1,2:Nt,2,1])
plot(2:Nt, jV[1,2:Nt,2,2])
...
par(mfrow=c(2,2))
plot(2:Nt, jPr2[1,2:Nt,1,1])
plot(2:Nt, jPr2[1,2:Nt,1,2])
plot(2:Nt, jPr2[1,2:Nt,2,1])
plot(2:Nt, jPr2[1,2:Nt,2,2])
