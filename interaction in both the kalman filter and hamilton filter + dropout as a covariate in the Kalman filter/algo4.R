      ...
      for (js in 1:nrow(jS)) {
        ...
        with_no_grad ({
          ...
          while (sum(as.numeric(torch_det(jP[,t,s1,s2,,])) < epsilon) > 0) {
            ...
            for (ind in jPInd) {jP[ind,t,s1,s2,,]$add_(3e-1 * torch_eye(Nf1))} } }) 
        ...
        if (length(naRows[[t]]) == N) {
          ...
          for (noNaRow in noNaRows[[t]]) {
            ...
            with_no_grad ({
              ...
              while (as.numeric(torch_det(jP2[noNaRow,t,s1,s2,,])) < epsilon) {jP2[noNaRow,t,s1,s2,,]$add_(3e-1 * torch_eye(Nf1)) } }) } }
      ...
      if (length(naRows[[t]]) == N) {jPr2[,t,,] <- torch_clone(jPr[,t,,])
        ...
        with_no_grad({
          ...
          for (noNaRow in noNaRows[[t]]) {
            ...
            with_no_grad ({
              if (as.numeric(torch_sum(jPr[noNaRow,t,,])) < epsilon) {jPr[noNaRow,t,,] <- jPr2[noNaRow,t-1,,]} }) } }
